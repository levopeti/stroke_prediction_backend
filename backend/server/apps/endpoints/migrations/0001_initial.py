# Generated by Django 2.2.13 on 2022-09-22 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v1', models.DecimalField(decimal_places=3, max_digits=4)),
                ('v2', models.DecimalField(decimal_places=3, max_digits=4)),
                ('v3', models.DecimalField(decimal_places=3, max_digits=4)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
